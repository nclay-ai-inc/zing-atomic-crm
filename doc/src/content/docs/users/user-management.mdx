...
description: This document explains how to manage users in ZingIQ.
---

## Creating the First User

The first time you open the ZingIQ App, you will be prompted to create the first user. This first user will automatically be granted administrator role.
